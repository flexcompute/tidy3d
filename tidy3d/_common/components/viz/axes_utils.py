...
from tidy3d._common.components.types.base import LengthUnit
from tidy3d._common.constants import UnitScaling
from tidy3d._common.exceptions import Tidy3dKeyError
...
if TYPE_CHECKING:
    ...
    from tidy3d._common.components.types.base import Ax, Axis
