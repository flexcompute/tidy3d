...
from tidy3d._common.components.autograd import TracedSize1D, get_static
from tidy3d._common.components.base import cached_property
from tidy3d._common.components.geometry import base
from tidy3d._common.components.geometry.mesh import TriangleMesh
from tidy3d._common.components.geometry.polyslab import PolySlab
from tidy3d._common.config import config
from tidy3d._common.constants import LARGE_NUMBER, MICROMETER
from tidy3d._common.exceptions import SetupError, ValidationError
...
if TYPE_CHECKING:
    ...
    from tidy3d._common.components.types.base import Axis, Bound, Coordinate, MatrixReal4x4, Shapely
