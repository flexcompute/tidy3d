...
from tidy3d._common.components.types.base import ArrayFloat1D
from tidy3d._common.exceptions import Tidy3dError

if TYPE_CHECKING:
    from tidy3d._common.components.types.base import ArrayFloat2D

if TYPE_CHECKING:
    from tidy3d._common.components.types import ArrayFloat2D
