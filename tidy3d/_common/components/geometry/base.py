...
from tidy3d._common.compat import _package_is_older_than
from tidy3d._common.components.autograd import TracedCoordinate, TracedFloat, TracedSize, get_static
from tidy3d._common.components.base import Tidy3dBaseModel, cached_property
from tidy3d._common.components.geometry.bound_ops import bounds_intersection, bounds_union
from tidy3d._common.components.geometry.float_utils import increment_float
...
from tidy3d._common.constants import LARGE_NUMBER, MICROMETER, RADIAN, fp_eps, inf
...
if TYPE_CHECKING:
    ...
    from tidy3d._common.components.viz import PlotParams, VisualizationSpec
