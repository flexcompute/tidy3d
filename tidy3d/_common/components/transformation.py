...
from tidy3d._common.components.autograd import TracedFloat
from tidy3d._common.components.base import Tidy3dBaseModel, cached_property
from tidy3d._common.components.types.base import Axis, Coordinate
from tidy3d._common.constants import RADIAN
from tidy3d._common.exceptions import ValidationError

if TYPE_CHECKING:
    from tidy3d._common.components.types.base import ArrayFloat2D, TensorReal
