...
from tidy3d._common.components.base_sim.source import AbstractSource
from tidy3d._common.components.geometry.base import Box
from tidy3d._common.components.source.time import SourceTimeType
from tidy3d._common.components.types.base import TYPE_TAG_STR
from tidy3d._common.components.validators import _assert_min_freq, _warn_unsupported_traced_argument
...
if TYPE_CHECKING:
    ...
    from tidy3d._common.components.types.base import Ax
    from tidy3d._common.components.viz import PlotParams
