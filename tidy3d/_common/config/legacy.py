...
from tidy3d._common._runtime import WASM_BUILD
...
if TYPE_CHECKING:
    ...
    from tidy3d._common.log import LogLevel
...
class LegacyConfigWrapper:
    ...
    def switch_profile(self, profile: str) -> None:
        ...
        try:
            from tidy3d._common.config import Env as _legacy_env
        except Exception:
            _legacy_env = None
...
class LegacyEnvironmentConfig:
    ...
    def active(self) -> None:
        ...
        if environment is None:
            from tidy3d._common.config import Env  # local import to avoid circular
