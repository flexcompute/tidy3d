    ...
    def smatrix_in_basis(
        ...
        for sweep_index in sweep_indices:
            ...
            if modes1_provided:
                ...
                S11 = O1out.dot(S11, "mode_index_out_old").dot(O1in, "mode_index_in_old")
                S12 = O1out.dot(S12, "mode_index_out_old")
                S21 = S21.dot(O1in, "mode_index_in_old")
            if modes2_provided:
                ...
                S12 = S12.dot(O2in, "mode_index_in_old")
                S21 = O2out.dot(S21, "mode_index_out_old")
                S22 = O2out.dot(S22, "mode_index_out_old").dot(O2in, "mode_index_in_old")
