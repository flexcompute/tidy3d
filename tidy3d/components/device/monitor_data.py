...
from .monitor import TemperatureMonitor, PotentialMonitor, DeviceMonitorType
...
class PotentialData(DeviceMonitorData):
    """Data associated with a :class:`PotentialMonitor`: spatial electroc potential field.
