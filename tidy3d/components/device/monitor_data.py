        ...
        for dim in range(3):
            ...
            if self.symmetry[dim] == 1:
                ...
                if mnt_bounds[1][dim] < data_bounds[0][dim]:
                    ...
                    # simple reflection
                    new_property = new_property.reflect(axis=dim, center=center, reflection_only=True)
...
class TemperatureData(DeviceMonitorData):
    ...
    def symmetry_expanded_copy(self) -> TemperatureData:
        ...
        new_property = self._symmetry_expanded_copy(property=self.temperature)
        return self.updated_copy(temperature=new_property, symmetry=(0, 0, 0))
