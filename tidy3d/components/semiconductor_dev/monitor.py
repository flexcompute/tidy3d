...
class SemiConDev(AbstractMonitor, ABC):
    """Abstract base class for semiconductor device monitors."""


class PotentialMonitor(SemiConDev):
    ...
    conformal: bool = pd.Field(
        ...
        "unstructured monitors (``unstructured = True``) ensures that returned field values "
...
class ChargeDensityMonitor(SemiConDev):
    """Charge density monitor."""
...
SemiConDevMonitorType = Union[PotentialMonitor, ChargeDensityMonitor]
