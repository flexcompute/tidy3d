...
# Error message for tensorial mode solver without tidy3d-extras
TENSORIAL_SOLVER_ERROR_MSG = (
    ...
    r"'pip install tidy3d\[extras]'. Alternatively, you can run the mode solver "
...
class EigSolver(Tidy3dBaseModel):
    ...
    def solver_tensorial(
        ...
        Note: The fully tensorial mode solver is only available through ``tidy3d-extras``
        or by running the mode solver through the Tidy3D server. This method raises an error
        directing users to those options.
        """
