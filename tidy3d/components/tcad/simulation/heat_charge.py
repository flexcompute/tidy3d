...
from tidy3d.components.material.tcad.charge import ChargeConductorMedium, SemiconductorMedium
from tidy3d.components.material.tcad.heat import SolidMedium
