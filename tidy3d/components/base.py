...
class Tidy3dBaseModel(BaseModel):
    ...
    def from_file(
        ...
        **model_validate_kwargs
        ...
        obj = cls.model_validate(model_dict, **parse_obj_kwargs)
        if not lazy and on_load is not None:
            on_load(obj)
        return obj

    @classmethod
    def dict_from_file(cls: type[T], fname: PathLike, group_path: Optional[str] = None) -> dict:
    ...
    def from_json(cls: type[T], fname: PathLike, **model_validate_kwargs: Any) -> Self:
        ...
        **model_validate_kwargs
        ...
        return cls.model_validate(model_dict, **model_validate_kwargs)
    ...
    class _LazyProxy(target_cls):  # type: ignore[misc]
        ...
        def __getattribute__(self, name: str):
            ...
            if "_lazy_fname" in d:
                ...
                target = target_cls.model_validate(model_dict, **kwargs)
