...
#
# Why is this one not an AbstractTransformation?
#
class FilterProject(AbstractTransformation):
...
TransformationType = typing.Union[FilterProject, RescaleTransformation]
