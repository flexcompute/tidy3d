...
Although `autograd` is used internally, Tidy3D includes a lightweight PyTorch wrapper for users who want to keep PyTorch-centric tensors and optimizer code. See the PyTorch wrapper [here](https://docs.flexcompute.com/projects/tidy3d/en/latest/api/plugins/pytorch.html).
