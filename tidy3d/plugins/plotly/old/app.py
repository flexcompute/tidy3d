...
class Tidy3dApp(Tidy3dBaseModel):
    ...
    simulation: Simulation = pd.Field(
        ..., title="Simulation", description="Simulation to generate the plots."
    )
    ...
    def start(self):
        ...
        app.layout = html.Div(
            ...
            children=[
                html.H1(
                    children="Hello Dash", style={"textAlign": "center", "color": colors["text"]}
                ),
                html.Div(
                    children="Dash: A web application framework for your data.",
                    style={"textAlign": "center", "color": colors["text"]},
                ),
                dcc.Slider(min=xmin, max=xmax, value=0, id="x_position"),
                dcc.Graph(figure=figx, id="plot_x"),
                dcc.Slider(min=ymin, max=ymax, value=0, id="y_position"),
                dcc.Graph(figure=figy, id="plot_y"),
                dcc.Slider(min=zmin, max=zmax, value=0, id="z_position"),
