...
@callback(
    Output({"type": "FieldTimeData_figure", "name": MATCH}, "figure"),
    [
        Input({"type": "FieldTimeData_field_dropdown", "name": MATCH}, "value"),
        Input({"type": "FieldTimeData_val_dropdown", "name": MATCH}, "value"),
        Input({"type": "FieldTimeData_cs_axis_dropdown", "name": MATCH}, "value"),
        Input({"type": "FieldTimeData_cs_slider", "name": MATCH}, "value"),
        Input({"type": "FieldTimeData_ft_slider", "name": MATCH}, "value"),
        Input("store", "data"),
    ],
    State({"type": "FieldTimeData_figure", "name": MATCH}, "id"),
)
...
@callback(
    Output({"type": "FieldTimeData_cs_slider", "name": MATCH}, "min"),
    Input({"type": "FieldTimeData_cs_axis_dropdown", "name": MATCH}, "value"),
    Input("store", "data"),
    State({"type": "FieldTimeData_figure", "name": MATCH}, "id"),
)
...
@callback(
    Output({"type": "FieldTimeData_cs_slider", "name": MATCH}, "value"),
    Input({"type": "FieldTimeData_cs_axis_dropdown", "name": MATCH}, "value"),
    Input("store", "data"),
    State({"type": "FieldTimeData_figure", "name": MATCH}, "id"),
)
...
@callback(
    Output({"type": "FieldTimeData_cs_slider", "name": MATCH}, "max"),
    Input({"type": "FieldTimeData_cs_axis_dropdown", "name": MATCH}, "value"),
    Input("store", "data"),
    State({"type": "FieldTimeData_figure", "name": MATCH}, "id"),
)
