...
class ModeSolver(Tidy3dBaseModel):
    ...
    def add_source(
        ...
        -------
        :class:`.Simulation`
            Copy of the simulation with a mode source with specifications taken
    ...
    def add_monitor(
        ...
        -------
        :class:`.Simulation`
            Copy of the simulation with a mode monitor with specifications taken
            from the ModeSolver instance and the method inputs.
        """
    ...
    def add_mode_solver_monitor(
        ...
        if not new_monitors:
            ...
            new_monitors = list(new_monitors).append(mode_solver_monitor)
        print(new_monitors)
        newSim = self.simulation.copy(update=dict(monitors=new_monitors))
