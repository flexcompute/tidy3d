    ...
    **Lectures:**
    ...
    def plot(
        ...
        **patch_kwargs,
        ...
        """Plot each mode plane simulation's components.
        ...
        **Notebooks**
        ...
        h_lim = [
            a_center[n_axis] - self.plane.size[axes[0]] / 2,
            a_center[n_axis] + self.plane.size[axes[0]] / 2,
        ]
        v_lim = [
            a_center[n_axis] - self.plane.size[axes[1]] / 2,
            a_center[n_axis] + self.plane.size[axes[1]] / 2,
        ]
    ...
    def plot_pml(
        ...
        # Mode plane grid.
        plane_grid = self.grid_snapped.centers
        coord_0 = getattr(plane_grid, coord[0])[1:-1]
        coord_1 = getattr(plane_grid, coord[1])[1:-1]
        ...
        if num_pml_0 > 0 or num_pml_1 > 0:
            ...
            pc = PatchCollection(
                pml_rect, alpha=0.7, facecolor="gray", edgecolor="gray", hatch="x", zorder=np.inf
            )
