...
SimulationType = Union[
    Simulation, HeatChargeSimulation, HeatSimulation, EMESimulation, ModeSimulation
]
...
class Tidy3dStub(BaseModel, TaskStub):
    ...
    def from_file(cls, file_path: str) -> SimulationType:
        ...
        file_path : str
            ...
            Union[:class:`.Simulation`, :class:`.HeatSimulation`, :class:`.EMESimulation`, :class:`.ModeSimulation`] from.
    ...
    def to_file(
        ...
        """Exports Union[:class:`.Simulation`, :class:`.HeatSimulation`, :class:`.EMESimulation`, :class:`.ModeSimulation`] instance to .yaml, .json,
        or .hdf5 file
    ...
    def to_hdf5_gz(self, fname: str, custom_encoders: List[Callable] = None) -> None:
        """Exports Union[:class:`.Simulation`, :class:`.HeatSimulation`, :class:`.EMESimulation`, :class:`.ModeSimulation`] instance to .hdf5.gz file.
...
class Tidy3dStubData(BaseModel, TaskStubData):
    ...
    def from_file(cls, file_path: str) -> SimulationDataType:
        """Loads a Union[:class:`.SimulationData`, :class:`.HeatSimulationData`, :class:`.EMESimulationData`, :class:`.ModeSimulationData`]
        from .yaml, .json, or .hdf5 file.
        ...
        file_path : str
            Full path to the .yaml or .json or .hdf5 file to load the
            Union[:class:`.SimulationData`, :class:`.HeatSimulationData`, :class:`.EMESimulationData`, :class:`.ModeSimulationData`] from.
    ...
    def to_file(self, file_path: str):
        """Exports Union[:class:`.SimulationData`, :class:`.HeatSimulationData`, :class:`.EMESimulationData`, :class:`.ModeSimulationData`] instance
        ...
        file_path : str
            ...
            Union[:class:`.SimulationData`, :class:`.HeatSimulationData`, :class:`.EMESimulationData`, :class:`.ModeSimulationData`] to.
    ...
    def postprocess(cls, file_path: str) -> SimulationDataType:
        ...
        Union[:class:`.SimulationData`, :class:`.HeatSimulationData`, :class:`.EMESimulationData`, :class:`.ModeSimulationData`] instance.
