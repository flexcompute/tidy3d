...
HMDS_Horiba = PoleResidue(
    eps_inf=1.0,
    poles=[
        ((-379816861999031.8, -1.8227252520914852e16), (0.0, 1.0029341899480378e16))
    ],
...
HfO2_Horiba = PoleResidue(
    eps_inf=1.0,
    poles=[
        ((-2278901171994190.5, -1.4098114301144558e16), (0.0, 1.3743164680834702e16))
    ],
    frequency_range=(362698386340789.0, 1450793545363156.0),
)
...
material_library = {
    "Ag": [Ag_Rakic1998, Ag_JohnsonChristy1972],
    "Al": [Al_Rakic1998],
    "Al2O3": [Al2O3_Horiba],
    "AlAs": [AlAs_Horiba, AlAs_FernOnton1971],
    "AlGaN": [AlGaN_Horiba],
    "AlN": [AlN_Horiba],
    "AlxOy": [AlxOy_Horiba],
    "Aminoacid": [Aminoacid_Horiba],
    "Au": [Au_JohnsonChristy1972],
    "BK7": [BK7_Zemax],
    "Be": [Be_Rakic1998],
    "CaF2": [CaF2_Horiba],
    "Cellulose": [Cellulose_Sultanova2009],
    "Cr": [Cr_Rakic1998],
    "Cu": [Cu_JohnsonChristy1972],
    "FusedSilica": [FusedSilica_Zemax],
    "GaAs": [GaAs_Skauli2003],
    "Ge": [Ge_Icenogle1976],
    "GeOx": [GeOx_Horiba],
    "H2O": [H2O_Horiba],
    "HMDS": [HMDS_Horiba],
    ...
    "InP": [InP_Pettit1965],
    "MgF2": [MgF2_Horiba],
    "MgO": [MgO_StephensMalitson1952],
    "Ni": [Ni_JohnsonChristy1972],
    "PEI": [PEI_Horiba],
    "PEN": [PEN_Horiba],
    "PET": [PET_Horiba],
    "PMMA": [PMMA_Horiba, PMMA_Sultanova2009],
    "PTFE": [PTFE_Horiba],
    "PVC": [PVC_Horiba],
    "Pd": [Pd_JohnsonChristy1972],
    "Polycarbonate": [Polycarbonate_Horiba, Polycarbonate_Sultanova2009],
    "Polystyrene": [Polystyrene_Sultanova2009],
    "Pt": [Pt_Werner2009],
    "Sapphire": [Sapphire_Horiba],
    "Si3N4": [Si3N4_Horiba, Si3N4_Philipp1973, Si3N4_Luke2015],
    "SiC": [SiC_Horiba],
    "SiN": [SiN_Horiba],
    "SiO2": [SiO2_Horiba],
    "SiON": [SiON_Horiba],
    ...
    "TiOx": [TiOx_Horiba],
    "W": [W_Werner2009],
    "Y2O3": [Y2O3_Horiba, Y2O3_Nigara1968],
    "YAG": [YAG_Zelmon1998],
    "ZrO2": [ZrO2_Horiba],
    "aSi": [aSi_Horiba],
    "cSi": [cSi_SalzbergVilla1957, cSi_Li1993_293K, cSi_Green2008],
}
