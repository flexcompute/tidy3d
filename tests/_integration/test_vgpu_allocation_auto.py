"""Integration test: submit a simulation with vgpu_allocation=None (auto, system decides)."""
...
print("\n--- Testing vgpu_allocation=None (auto, system decides GPU count) ---")
data = td.web.run(
    sim,
    task_name="integration_vgpu_auto",
    path="data/data_auto.hdf5",
    verbose=True,
)
