...
def test_2dcorner_finder_filter_collinear_vertex():
    ...
    # if angle threshold is 0 and distance threshold unapplied, collinear vertex will not be filtered
    corner_finder = CORNER_FINDER.updated_copy(angle_threshold=0, distance_threshold=None)
    corners = corner_finder.corners(normal_axis=2, coord=0, structure_list=structures)
