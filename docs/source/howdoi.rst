...
.. list-table::
   ...
   * - Create a material from optical n,k data?
     - Refer to the `Dispersion tutorial <https://docs.flexcompute.com/projects/tidy3d/en/v1.9.0rc2/notebooks/Fitting.html>`_ on the :class:`tidy3d.plugins.DispersionFitter` plugin.
   * - Specify the modes for a :class:`ModeMonitor` or :class:`ModeSource`?
     - Refer to the `Mode Solver tutorial <https://docs.flexcompute.com/projects/tidy3d/en/v1.9.0rc2/notebooks/ModeSolver.html>`_ on the :class:`tidy3d.plugins.ModeSolver` plugin.
   * - Projet electromagnetic near field data to the far field?
     - Refer to the `FieldProjections` tutorial <https://docs.flexcompute.com/projects/tidy3d/en/v1.9.0rc2/notebooks/FieldProjections.html>`_.
   * - Compute scattering matrix parameters for modeling my device?
     - Refer to the `S Matrix tutorial <https://docs.flexcompute.com/projects/tidy3d/en/v1.9.0rc2/notebooks/SMatrix.html>`_ on the :class:`tidy3d.plugins.ComponentModeler` plugin.
