...
.. autosummary::
   ...
   plugins.invdes.utils.get_amps
   plugins.invdes.utils.get_field_component
   plugins.invdes.utils.get_intensity
   plugins.invdes.utils.sum_array
   plugins.invdes.utils.sum_abs_squared
   plugins.invdes.utils.get_phase
